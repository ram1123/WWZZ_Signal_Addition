...
// Fri Jan 29 04:12:12 2021 by ROOT version 6.14/09
// from TTree GluGluToHHTo2G2ZTo2G4Q_node_cHHH1_13TeV_HHWWggTag_1/GluGluToHHTo2G2ZTo2G4Q_node_cHHH1_13TeV_HHWWggTag_1
// found on file: /tmp/rasharma/RemovedDuplicates_GluGluToHHTo2G2ZTo2G4Q_node_cHHH1_2016_Trimmed.root
//////////////////////////////////////////////////////////

#ifndef flashgg_ZZMC_h
#define flashgg_ZZMC_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         New_OnShellW_LeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb;
   Float_t         New_OnShellW_SubLeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb;
   Float_t         New_OffShellW_LeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb;
   Float_t         New_OffShellW_SubLeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb;
   ...
   TBranch        *b_New_OnShellW_LeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb;   //!
   TBranch        *b_New_OnShellW_SubLeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb;   //!
   TBranch        *b_New_OffShellW_LeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb;   //!
   TBranch        *b_New_OffShellW_SubLeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb;   //!

   flashgg_ZZMC(TTree *tree=0) {
       if (tree == 0) {
         TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/tmp/rasharma/RemovedDuplicates_GluGluToHHTo2G2ZTo2G4Q_node_cHHH1_2016_Trimmed.root");
         if (!f || !f->IsOpen()) {
            f = new TFile("/tmp/rasharma/RemovedDuplicates_GluGluToHHTo2G2ZTo2G4Q_node_cHHH1_2016_Trimmed.root");
         }
         f->GetObject("GluGluToHHTo2G2ZTo2G4Q_node_cHHH1_13TeV_HHWWggTag_1",tree);
      }
      Init(tree);
   };
   virtual ~flashgg_ZZMC(){
    if (!fChain) return;
...
Int_t flashgg_ZZMC::GetEntry(Long64_t entry)
{
...
Long64_t flashgg_ZZMC::LoadTree(Long64_t entry)
{
...
void flashgg_ZZMC::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("New_OnShellW_LeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb", &New_OnShellW_LeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb, &b_New_OnShellW_LeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb);
   fChain->SetBranchAddress("New_OnShellW_SubLeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb", &New_OnShellW_SubLeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb, &b_New_OnShellW_SubLeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb);
   fChain->SetBranchAddress("New_OffShellW_LeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb", &New_OffShellW_LeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb, &b_New_OffShellW_LeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb);
   fChain->SetBranchAddress("New_OffShellW_SubLeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb", &New_OffShellW_SubLeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb, &b_New_OffShellW_SubLeadingJet_bDiscriminator_mini_pfDeepFlavourJetTags_probb);
}
