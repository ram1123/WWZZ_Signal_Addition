...
// Tue Jan 26 17:18:19 2021 by ROOT version 6.14/09
// from TTree GluGluToHHTo2G4Q_node_cHHH1_13TeV_HHWWggTag_1/GluGluToHHTo2G4Q_node_cHHH1_13TeV_HHWWggTag_1
// found on file: /eos/user/r/rasharma/post_doc_ihep/double-higgs/ntuples/January_2021_Production/2016/Signal//FHWW_NLO_2016_Hadded/nodecHHH1_GluGluToHHTo2G4Q.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   flashgg_MC(TTree *tree=0){
      if (tree == 0) {
         TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/user/r/rasharma/post_doc_ihep/double-higgs/ntuples/January_2021_Production/2016/Signal//FHWW_NLO_2016_Hadded/nodecHHH1_GluGluToHHTo2G4Q.root");
         if (!f || !f->IsOpen()) {
            f = new TFile("/eos/user/r/rasharma/post_doc_ihep/double-higgs/ntuples/January_2021_Production/2016/Signal//FHWW_NLO_2016_Hadded/nodecHHH1_GluGluToHHTo2G4Q.root");
         }
         TDirectory * dir = (TDirectory*)f->Get("/eos/user/r/rasharma/post_doc_ihep/double-higgs/ntuples/January_2021_Production/2016/Signal//FHWW_NLO_2016_Hadded/nodecHHH1_GluGluToHHTo2G4Q.root:/tagsDumper/trees");
...
Int_t flashgg_MC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t flashgg_MC::LoadTree(Long64_t entry)
{
...
void flashgg_MC::Init(TTree *tree)
{
   ...
   // if (fChain->GetBranchStatus("b_allJets_1_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_2_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_3_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_4_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_5_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_6_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_7_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_8_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_9_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_0_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_1_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_2_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_3_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_4_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_5_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_6_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_7_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_8_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_9_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_0_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_1_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_2_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_3_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_4_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_5_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_6_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_7_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_8_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_9_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_0_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_1_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_2_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_3_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_4_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_5_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_6_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_7_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_8_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_9_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_0_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_1_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_2_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_3_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_4_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_5_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_6_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_7_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_8_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_allJets_9_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_goodElectrons_1_passMVAMediumId"))
   ...
   // if (fChain->GetBranchStatus("b_goodElectrons_2_passMVAMediumId"))
   ...
   // if (fChain->GetBranchStatus("b_goodElectrons_3_passMVAMediumId"))
   ...
   // if (fChain->GetBranchStatus("b_goodElectrons_4_passMVAMediumId"))
   ...
   // if (fChain->GetBranchStatus("b_goodElectrons_5_passMVAMediumId"))
   ...
   // if (fChain->GetBranchStatus("b_goodElectrons_6_passMVAMediumId"))
   ...
   // if (fChain->GetBranchStatus("b_goodElectrons_7_passMVAMediumId"))
   ...
   // if (fChain->GetBranchStatus("b_goodElectrons_8_passMVAMediumId"))
   ...
   // if (fChain->GetBranchStatus("b_goodElectrons_9_passMVAMediumId"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_1_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_2_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_3_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_4_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_5_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_6_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_7_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_8_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_9_bDiscriminator_mini_pfDeepFlavourJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_0_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_1_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_2_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_3_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_4_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_5_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_6_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_7_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_8_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_9_bDiscriminator_pfDeepCSVJetTags_probb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_0_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_1_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_2_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_3_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_4_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_5_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_6_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_7_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_8_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_9_bDiscriminator_mini_pfDeepFlavourJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_0_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_1_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_2_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_3_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_4_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_5_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_6_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_7_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_8_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_9_bDiscriminator_pfDeepCSVJetTags_probbb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_0_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_1_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_2_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_3_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_4_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_5_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_6_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_7_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_8_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_goodJets_9_bDiscriminator_mini_pfDeepFlavourJetTags_problepb"))
   ...
   // if (fChain->GetBranchStatus("b_prefireWeightDown01sigma"))
      fChain->SetBranchAddress("prefireWeightDown01sigma", &prefireWeightDown01sigma, &b_prefireWeightDown01sigma);
   // if (fChain->GetBranchStatus("b_rho"))
      fChain->SetBranchAddress("rho", &rho, &b_rho);
   // if (fChain->GetBranchStatus("b_nvtx"))
      fChain->SetBranchAddress("nvtx", &nvtx, &b_nvtx);
   // if (fChain->GetBranchStatus("b_event"))
      fChain->SetBranchAddress("event", &event, &b_event);
   // if (fChain->GetBranchStatus("b_lumi"))
      fChain->SetBranchAddress("lumi", &lumi, &b_lumi);
   // if (fChain->GetBranchStatus("b_processIndex"))
      fChain->SetBranchAddress("processIndex", &processIndex, &b_processIndex);
   // if (fChain->GetBranchStatus("b_run"))
      fChain->SetBranchAddress("run", &run, &b_run);
   // if (fChain->GetBranchStatus("b_npu"))
      fChain->SetBranchAddress("npu", &npu, &b_npu);
   // if (fChain->GetBranchStatus("b_puweight"))
      fChain->SetBranchAddress("puweight", &puweight, &b_puweight);
   // if (fChain->GetBranchStatus("b_pdfWeights"))
      fChain->SetBranchAddress("pdfWeights", pdfWeights, &b_pdfWeights);
   // if (fChain->GetBranchStatus("b_alphaSWeights"))
      fChain->SetBranchAddress("alphaSWeights", alphaSWeights, &b_alphaSWeights);
   // if (fChain->GetBranchStatus("b_scaleWeights"))
